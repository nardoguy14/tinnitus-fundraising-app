...
function InfoComponent() {
  return (
        <div className="jdrf-p2p-greeting__content-tabs js--event-page-tabs" aria-hidden="false">
          <md-tabs className="jdrf-p2p-tabs ng-isolate-scope md-dynamic-height">
            <md-tabs-wrapper>
              <md-tab-data>
                <md-tab className="ng-scope ng-isolate-scope" ></md-tab>

                <md-tab className="ng-scope ng-isolate-scope"></md-tab>
              </md-tab-data>

              <md-tabs-canvas>
                <md-pagination-wrapper aria-label="Use the left and right arrow keys to navigate between tabs"
                                       style={{transform: "translate(0px, 0px)"}}>
                  <md-tab-item className="md-tab">
                    <span className="ng-binding ng-scope">Event Day Details</span>
                    <div className="md-ripple-container" ></div>
                  </md-tab-item>
                  <md-tab-item className="md-tab md-active">
                    <span>Walk News</span>
                    <div className="md-ripple-container"></div>
                  </md-tab-item>
                  <md-ink-bar style={{left: "152px", right: "0px"}} className=""></md-ink-bar>
                </md-pagination-wrapper>

                <md-tabs-dummy-wrapper aria-hidden="true"
                                       className="md-visually-hidden md-dummy-wrapper">
                  <md-dummy-tab className="md-tab">
                    <span className="ng-binding ng-scope">Event Day Details</span>
                  </md-dummy-tab>
                  <md-dummy-tab className="md-tab">
                    <span>Walk News</span>
            ...
            <md-tabs-content-wrapper className="_md">
              <md-tab-content className="_md ng-scope md-no-scroll md-left">
                <div>
              ...
              <md-tab-content className="_md ng-scope md-no-scroll md-active">
